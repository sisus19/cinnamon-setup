...
apt update && apt full-upgrade && apt install cinnamon tasksel lightdm cinnamon-core fonts-liberation gedit git gnome-screenshot vlc cups gedit-plugins htop neofetch gstreamer1.0-libav gstreamer1.0-plugins-ugly libreoffice-writer orca eog system-config-printer zenity amd64-microcode firmware-amd-graphics firmware-realtek fwupd-amd64-signed r8168-dkms adb fastboot mupdf xdg-user-dirs-gtk build-essential ccache libncurses5 libssl-dev m4 unzip brotli bc bison curl flex g++-multilib gcc-multilib gnupg gperf imagemagick lib32ncurses5-dev lib32readline-dev lib32z1-dev liblz4-tool libncurses5-dev libsdl1.2-dev libxml2 libxml2-utils lzop pngcrush rsync schedtool squashfs-tools xsltproc zip zlib1g-dev python python3.9 abootimg libc6-dev-i386 x11proto-core-dev libx11-dev libgl1-mesa-dev fontconfig redshift imagemagick-6.q16- blueman- -y
